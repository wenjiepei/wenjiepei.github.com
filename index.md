...
__ACM MM__, <span style="color:red">Oral</span>, 2022.  

- Fengjun Li, Xin Feng, Fanglin Chen, Guangming Lu, and __Wenjie Pei__\*. (\*corresponding authors.)  
Learning Generalizable Latent Representations for Novel Degradations in Super-Resolution.  
__ACM MM__, 2022.  

- Zebin Lin, __Wenjie Pei__\*, Fanglin Chen, David Zhang and Guangming Lu\*. (\* corresponding author.)  
[Pedestrian Detection by Exemplar-Guided Contrastive Learning]([https://arxiv.org/abs/1908.10535](https://arxiv.org/pdf/2111.08974.pdf)).  
IEEE Transactions on Image Processing (__TIP__), 2022.  

- Zikun Zhou, Jianqiu Chen, __Wenjie Pei__\*, Kaige Mao, Hongpeng Wang, Zhenyu He*.(\*corresponding authors).  
Global Tracking via Ensemble of Local Trackers.  
__CVPR__, 2022.  

- Bin Liang, Chenwei Lou, Xiang Li, Min Yang, Lin Gui, Yulan He, __Wenjie Pei__, Ruifeng Xu.  
Multi-Modal Sarcasm Detection via Cross-Modal Graph Convolutional Network.  
__ACL__, 2022.  

- Zengwei Yao, __Wenjie Pei__\*, Fanglin Chen, Guangming Lu\*, David Zhang. (\* corresponding authors.)  
Stepwise-Refining Speech Separation Network via Fine-Grained Encoding in High-order Latent Domain.  
IEEE Transactions on Audio, Speech, and Language Processing (__TASLP__), 2021.  

- Zikun Zhou, __Wenjie Pei__\*, Xin Li, Hongpeng Wang, Feng Zheng, Zhenyu He\*. (\* corresponding authors.)  
Saliency-Associated Object Tracking.  
__ICCV__, 2021.  

- Jing Li, Di Kang, __Wenjie Pei__, Xuefei Zhe, Ying Zhang, Zhenyu He, Linchao Bao.  
Audio2Motion: Generating Diverse Human Motion from Audio with Conditional Variational Autoencoders.  
__ICCV__, 2021.  

- Xin Feng, __Wenjie Pei__\*, Zihui Jia, Fanglin Chen, David Zhang, Guangming Lu\*. (\* corresponding authors.)  
[Deep-Masking Generative Network: A Unified Framework for Background Restoration from Superimposed Images](https://arxiv.org/abs/2010.04324).  
IEEE Transactions on Image Processing (__TIP__), 2021.  

- Kai Yang, Zhenyu He\*, __Wenjie Pei__\*, Zikun Zhou, Xin Li, Di Yuan, Haijun Zhang. (\* corresponding authors.)  
[SiamCorners: Siamese Corner Networks for Visual Tracking](https://arxiv.org/abs/2104.07303).  
IEEE Transactions on Multimedia (__TMM__), 2021.  

- Weinong Wang, __Wenjie Pei__\*, Qiong Cao, Shu Liu, Guangming Lu and Yu-Wing Tai. (\* corresponding author.)  
[Push for Center Learning via Orthogonalization and Subspace Masking for Person Re-Identification](https://arxiv.org/abs/1908.10535).  
IEEE Transactions on Image Processing (__TIP__), 2021.  

- Yi Li, __Wenjie Pei__<sup>*</sup> and Zhenyu He<sup>*</sup>. (<sup>*</sup> Joint corresponding authors.)  
[SRHEN: Stepwise-Refining Homography Estimation Network via Parsing Geometric Correspondence in Deep Latent Space](coming soon).  
__ACM MM__, 2020.  

- Jiadong Liang<sup>#</sup>, __Wenjie Pei__<sup>#</sup> and Feng Lu. (<sup>#</sup> Equal contribution.)  
[CPGAN: Full-Spectrum Content-Parsing Generative Adversarial Networks for Text-to-Image Synthesis](https://arxiv.org/pdf/1912.08562.pdf).  
__ECCV__  <span style="color:red">Spotlight</span>, (5% acceptance rate), 2020.  
[\[Code\]](https://github.com/dongdongdong666/CPGAN)

- Qi Fan, Lei Ke, __Wenjie Pei__\*, Chi-Keung Tang and Yu-Wing Tai. (\* Corresponding author.)  
[Commonality-Parsing Network across Shape and Appearance for Partially Supervised Instance Segmentation](/publication/CPMask.pdf).  
__ECCV__, 2020.  

- __Wenjie Pei__, Hamdi Dibeklioğlu, Tadas Baltrušaitis and David M.J. Tax.  
[Attended End-to-end Architecture for Age Estimation from Facial Expression Videos](https://arxiv.org/pdf/1711.08690.pdf).  
IEEE Transactions on Image Processing (__TIP__), 2020.  

- Canmiao Fu<sup>#</sup>, __Wenjie Pei__<sup>#</sup>, Qiong Cao, Chaopeng Zhang, Xiaoyong Shen, Yong Zhao and Yu-wing Tai. (<sup>#</sup>both authors contributed equally).  
[Non-local Recurrent Neural Memory for supervised Sequence Modeling](https://arxiv.org/abs/1908.09535).  
__ICCV__ <span style="color:red">Oral</span>, (4.3% acceptance rate), 2019.  

- Lei Ke, __Wenjie Pei__, Ruiyu Li, Xiaoyong Shen and Yu-wing Tai. (This work is conducted by my intern Lei under my supervision).  
[Reflective Decoding Network for Image Captioning](https://arxiv.org/abs/1908.11824).  
__ICCV__, 2019.  

- Yunqiang Li<sup>#</sup>, __Wenjie Pei__<sup>#</sup>, Yufei Zha and Jan van Gemert (<sup>#</sup>both authors contributed 
equally).  
[Push for Quantization: Deep Fisher Hashing](https://arxiv.org/abs/1909.00206).  
British Machine Vision Conference (__BMVC__) <span style="color:red">Oral</span>, (4.7% acceptance rate), 2019.  

- __Wenjie Pei__, Jiyuan Zhang, Xiangrong Wang, Lei Ke, Xiaoyong Shen and Yu-wing Tai.  
[Memory-Attended Recurrent Network for Video Captioning](http://openaccess.thecvf.com/content_CVPR_2019/papers/Pei_Memory-Attended_Recurrent_Network_for_Video_Captioning_CVPR_2019_paper.pdf).  
IEEE Conference on Computer Vision and Pattern Recognition (__CVPR__), 2019.  

- __Wenjie Pei__<sup>#</sup>, Jie Yang<sup>#</sup>, Zhu Sun, Jie Zhang, Alessandro Bozzon and David M.J. Tax (<sup>#</sup>both authors contributed equally).  
[Interacting Attention-gated Recurrent Networks for Recommendation](https://arxiv.org/abs/1709.01532).  
ACM International Conference on Information and Knowledge Management (__CIKM__),  
__full__ paper, 2017.  
[\[Code\]](https://github.com/wenjiepei/IARN)
